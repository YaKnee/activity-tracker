...
if (init) {
  ...
  let initial_tags = ['household chore', 'school', 'hobby', 'important', 'full stack', 'btest', 'atest'];
  ...
  if (!empty) {
    ...
    db.serialize(() => {
      db.run('INSERT INTO tags (name) VALUES ' + placeholders, initial_tags)
        ...
        .run(`INSERT INTO tasks (name, tags) VALUES ('tester', '6,7');`)
        ...
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-10-31 11:00:00.111', 3, 1);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-10-31 10:00:00.111', 3, 1);`)
        .run(`INSERT INTO timestamps (timestamp, task, type) VALUES ('2024-10-31 10:30:00.111', 3, 0);`)
